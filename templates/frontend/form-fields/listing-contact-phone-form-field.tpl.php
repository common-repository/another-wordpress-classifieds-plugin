...
?><p class="awpcp-form-field awpcp-clearfix   awpcp-form-spacer">
    ...
    <input class="awpcp-textfield awpcp-has-value inputbox <?php echo esc_attr( $validators ); ?>" id="<?php echo esc_attr( $html['id'] ); ?>" <?php echo $html['readonly'] ? 'readonly="readonly"' : ''; ?> type="text" size="50" name="<?php echo esc_attr( $html['name'] ); ?>" value="<?php echo awpcp_esc_attr( $value ); ?>" />
